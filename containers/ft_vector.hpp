...
namespace ft
{
	...
	public:
		...
		void insert(iterator position, size_type n, const value_type &val)
		{
			...
			template <class InputIterator>
			void insert(iterator position, typename ft::enable_if<!ft::is_integral<InputIterator>::value, InputIterator>::type first, // nececita mesmo do enable_if??
						InputIterator last)
			{
				size_type index = position - this->begin();
		...
		{
			size_type n = ft::distance(fist, last);
